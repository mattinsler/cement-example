 ...
 *
 */
public abstract class SocialEntity implements com.mattinsler.guiceymongo.data.IsData {
    ...
    public static com.mattinsler.guiceymongo.data.DataWrapper<SocialEntity> DataWrapper =
        new com.mattinsler.guiceymongo.data.DataWrapper<SocialEntity>() {
    ...
    public static SocialEntity.Wrapper convertFrom(
        ...
        return new SocialEntity.Wrapper(((com.mattinsler.guiceymongo.data.IsWrapper<?>) data).getDBObject());
    }
    ...
    public static class Wrapper extends SocialEntity implements com.mattinsler.guiceymongo.data.IsWrapper<SocialEntity> {
    ...
    public static class Builder extends SocialEntity implements com.mattinsler.guiceymongo.data.IsBuilder<SocialEntity> {
        /**
         *
         */
